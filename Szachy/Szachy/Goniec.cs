    ...
    internal class Goniec : Figura
    {
        public override bool mozliwe_ruchy(Figura[,] szachownica, System.Windows.Controls.Button[,] podswietlenia)
        {
            /*for (int x = 0; x < 8; x++)
            {
                for (int j = 0; j < 8; j++)
                {
                    podswietlenia[x, j].Visibility = System.Windows.Visibility.Hidden;
                }
            }*/
        ...
        public Goniec (bool kolor, int pole_X, int pole_y, System.Windows.Controls.Button obiekt)
        {
            this.kolor = kolor;
            this.pole_x = pole_X;
            this.pole_y = pole_y;
